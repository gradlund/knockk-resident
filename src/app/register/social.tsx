...
const social = () => {
  ...
  const [error, setError] = useState<String>("The following information is voluntary and will show up once you connect with a neighbor.")
...
return (
  <View style={[styles.GeneralContainer]}>
      <View style={{top: 20, paddingBottom: 10, position: "absolute"}}><Warning message={error.toString()} /></View>
    <View style={[{top: 150}]}>
      <View>
        <Controller
          control={control}
