...
export const ResidentRow = ({
  ...
  let photoURI = "";
  // If the photo is undefined and is connected, set the image to a default
  ...
  return (
    ...
    <View  
    style={[styles.container, {backgroundColor: isConnected ? "rgb(230, 224, 255)" : "rgb(242, 240, 253)"}]}
    >
      <Link
